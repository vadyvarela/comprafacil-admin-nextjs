...
import { buildHomePreviewUrl } from "./preview-actions"
...
const PREVIEW_BESIDE_STORAGE_KEY = "techstore-backoffice:settings:page-builder:preview-beside"
...
export default function StoreHomePage() {
  ...
  const expandAllBlocks = useCallback(() => {
    ...
    setBlockBodyOpen(Object.fromEntries(doc.blocks.map((b) => [b.id, true])))
  }, [doc.blocks])
                    ...
                    >
                      <div className="space-y-3">
                        {doc.blocks.map((block, index) => {
                          const bodyOpen = blockBodyOpen[block.id] === true
