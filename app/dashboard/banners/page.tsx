                        ...
                        {filteredBanners.map((banner) => {
                          ...
                          return (
                            <tr key={banner.id} className="border-b border-border last:border-b-0 hover:bg-muted/20 transition-colors">
                              ...
                              <td className="px-4 py-3 text-xs font-medium text-foreground tabular-nums">
                                {banner.orderIndex ?? "—"}
                              </td>
                              <td className="px-4 py-3">
                        ...
                        <div key={banner.id} className="rounded-xl border border-border bg-card overflow-hidden">
                          <div className="relative h-36 bg-muted">
                            ...
                            <div className="absolute top-2 left-2 flex gap-1.5">
                              {isActive ? (
                                <span className="inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-medium badge-success backdrop-blur-sm">
                                  <CheckCircle2 className="h-3 w-3" />
                                  Ativo
                                </span>
                              ) : (
                                <span className="inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-medium badge-neutral backdrop-blur-sm">
                                  <XCircle className="h-3 w-3" />
                                  Inativo
                                </span>
                              )}
                          ...
                          <div className="p-3">
                            ...
                            <div className="mt-2 space-y-1 text-[11px] text-muted-foreground">
                              ...
                              <p>Ordem: <span className="text-foreground tabular-nums">{banner.orderIndex ?? "—"}</span></p>
                            </div>
                            <div className="mt-3 flex items-center gap-2">
                              <Button variant="outline" size="sm" className="h-7 text-xs flex-1" onClick={() => handleEditBanner(banner)}>
                                <Edit className="h-3.5 w-3.5 mr-1.5" />
                                Editar
                              </Button>
                              <Button
