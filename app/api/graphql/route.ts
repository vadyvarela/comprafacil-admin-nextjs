...
const ROOT_FIELD_ACCESS: Record<string, OperationAccess> = {
  ...
  marketingDesk: { module: "marketing", mode: "read" },
  marketingThreads: { module: "marketing", mode: "read" },
  marketingThread: { module: "marketing", mode: "read" },
  marketingProposals: { module: "marketing", mode: "read" },
  marketingCampaigns: { module: "marketing", mode: "read" },
  marketingCampaign: { module: "marketing", mode: "read" },
  marketingLiveCampaign: { module: "marketing", mode: "read" },
  ...
  createMarketingCampaign: { module: "marketing", mode: "write" },
  updateMarketingCampaign: { module: "marketing", mode: "write" },
  setMarketingCampaignStatus: { module: "marketing", mode: "write" },
  attachMarketingCampaignAssets: { module: "marketing", mode: "write" },
