export const MARKETING_AGENT_TOOLS = [
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          link: { type: "string", description: "/campanha, /produto/…, /ofertas, /categoria/…" },
          position: { type: "string", enum: ["hero", "hero-side", "promo"] },
  ...
  },
  {
    type: "function" as const,
    function: {
      name: "propose_banner_update",
      description:
        "Alterar ou desligar um banner existente. bannerId obrigatório (list_banners). status INACTIVE tira do site.",
      parameters: {
        type: "object",
        properties: {
