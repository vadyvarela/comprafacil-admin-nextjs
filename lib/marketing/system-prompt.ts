...
- Pack de publicação que vende (quando o gestor pede um post, não uma campanha nova):
  ...
  6. ${input.intent === "campaign" ? "Neste ecrã usa propose_campaign, não propose_social_pack." : "Usa propose_social_pack. Se houver campanha live, passa campaignId. Não cries campanha nova só por um post."}
...
- Depois das tools, resume em 4–8 linhas o que propuseste e diz: «${input.intent === "campaign" ? "À direita: copia ou Meter na loja" : "À direita: Publicar — copia e cola nas redes"}». Não inventes checklist Ads se não houver copy.
