...
- Banner novo: propose_banner com title curto (máx. ~8 palavras), subtitle (1 linha), buttonText (2–4 palavras), link, position hero (ou hero-side se pedirem lateral), imagePrompt paisagem 16:9 do produto/oferta. startDate e endDate ISO se houver prazo.
- Sempre propose_image_prompt formato banner no mesmo tema.
